...
public class WechatAPI {
    ...
    private String USER_INFO_PREFIX = "https://api.weixin.qq.com/sns/userinfo";
    ...
    public SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
        ...
        // 拼接请求地址
        String requestUrl = this.WEB_AUTH_PREFIX+"userinfo?access_token=ACCESS_TOKEN&openid=OPENID";
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken).replace("OPENID", openId);
        // 通过网页授权获取用户信息
        com.alibaba.fastjson.JSONObject jsonObject =  JSON.parseObject(HttpUtils.sendGetRequest(requestUrl));
