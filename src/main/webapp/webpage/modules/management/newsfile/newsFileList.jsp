...
<head>
	...
	<%@include file="newsFileList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">新闻公告附件列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="newsFile" class="form form-horizontal well clearfix">
				...
				<div class="col-xs-12 col-sm-6 col-md-2" style="margin-top:4px">
					<label class="label-item single-overflow pull-right" title="文件原名称：">文件原名称：</label>
				</div>
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="management:newsfile:newsFile:del">
			...
			<shiro:hasPermission name="management:newsfile:newsFile:export">
					...
					<i class="fa fa-file-excel-o"></i> 导出
	                 ...
	                 <shiro:hasPermission name="management:newsfile:newsFile:view">
	...
	<!-- 表格 -->
	<table id="newsFileTable"   data-toolbar="#toolbar"></table>
