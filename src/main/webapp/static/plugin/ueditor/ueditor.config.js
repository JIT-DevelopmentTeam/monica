...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["inserthtml","fullscreen","undo","redo","link","unlink","print","preview","insertimage","emotion",
            "insertvideo","date","time","bold","italic","underline","fontborder","strikethrough","forecolor",
            "backcolor","justifyleft","justifycenter","justifyright","justifyjustify","indent","removeformat",
            "paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone",
            "imageleft","imageright","imagecenter","inserttable","deletetable"]]
