 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/stockandentry/stock")
public class StockController extends BaseController {
	 ...
	 * 库存查询列表页面
	 */
	@RequiresPermissions("stockandentry:stock:list")
	@RequestMapping(value = {"list", ""})
	public String list(Stock stock, Model model) {
		model.addAttribute("stock", stock);
		return "management/stockandentry/stockList";
	}
	 ...
	 * 查看，增加，编辑库存查询表单页面
	 */
	@RequiresPermissions(value={"stockandentry:stock:view","stockandentry:stock:add","stockandentry:stock:edit"},logical=Logical.OR)
	@RequestMapping(value = "form")
	public String form(Stock stock, Model model) {
		model.addAttribute("stock", stock);
		return "management/stockandentry/stockForm";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value={"stockandentry:stock:add","stockandentry:stock:edit"},logical=Logical.OR)
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("stockandentry:stock:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("stockandentry:stock:export")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("stockandentry:stock:import")
