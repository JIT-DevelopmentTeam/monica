...
$(document).ready(function() {
  ...
  function refresh(){
   ...
   function add(){
	  jp.openSaveDialog('新增仓库管理表', "${ctx}/management/warehouse/warehouse/form",'800px', '500px');
  }
   ...
   function edit(id){//没有权限时，不显示确定按钮
	...
	jp.openSaveDialog('编辑仓库管理表', "${ctx}/management/warehouse/warehouse/form?id=" + id, '800px', '500px');
  }
 ...
 function view(id){//没有权限时，不显示确定按钮
      if(id == undefined){
        ...
        jp.openViewDialog('查看仓库管理表', "${ctx}/management/warehouse/warehouse/form?id=" + id, '800px', '500px');
 }
