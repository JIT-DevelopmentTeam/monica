...
<script type="text/javascript">
    ...
    $('#table').bootstrapTable({
        ...
        columns: [{
            ...
            title: 'ERP编号',
            sortable: true,
            sortName: 'erpUserNumber'
        }, {
            field: 'erpUserName',
            title: 'ERP名称',
            sortable: true,
            sortName: 'erpUserName'
        }]
    ...
    $('#table').on('check.bs.table uncheck.bs.table load-success.bs.table ' +
        ...
        $('#edit,#bindingERP').prop('disabled', $('#table').bootstrapTable('getSelections').length!=1);
    });
        ...
        format: "YYYY-MM-DD HH:mm:ss"
          ...
          /*同步用户*/
			...
			function bindingERP() {
                ...
                jp.openSaveDialog('绑定ERP用户', "${ctx}/sys/user/listPageERPUsers?userId="+id,'800px', '680px');
            }
	</script>