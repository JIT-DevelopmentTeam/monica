                ...
                <div class="ibox-content">
                    <div class="page-container">
                        ...
                        <div id="uploader" class="wu-example">
                           <%-- <div>
                                <select name="" id="disType" class="form-control ">
                                    <option value="">请选择文件归类</option>
                                    <c:forEach items="${disTypeList}" var="var" varStatus="vs">
                                        <option value="${var.id}">${var.label}</option>
                                    </c:forEach>
                                </select>
                            </div>--%>
                            <div class="queueList">
...
<script>
    jQuery(function() {
        ...
        if ( !WebUploader.Uploader.support() ) {
            ...
            throw new Error( 'Webuploader不支持您使用的浏览器。' );
        }
