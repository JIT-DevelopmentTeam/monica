...
<div id="page">
    ...
    <div class="order-panel">
        ...
        <div class="addOrder-list">
            ...
            <div class="addOrder-list_ft">
                <input class="weui-input" id="typeSelect" readonly type="text" placeholder="请选择类型"
        ...
        <div class="addOrder-list">
            ...
            <div class="addOrder-list_ft">
                <input placeholder="请选择日期" id="needTime" name="needTime" class="weui-input"
        ...
        <div class="addOrder-list">
            ...
            <div class="addOrder-list_ft">
                <input placeholder="请选择跟单人员" type="text" id="followerName" readonly class="weui-input open-popup"
                       data-target="#follower" style="text-align: right;"/>
            </div>
        </div>
        <div class="addOrder-list">
            <div class="addOrder-list_bd">
            ...
            <div class="addOrder-list_ft">
                <input type="text" id="createDate" name="createDate" readonly
                       value="<fmt:formatDate value="${sobill.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
                       class="weui-input" style="text-align: right;"/>
            </div>
        </div>
        <div class="addOrder-list">
            <div class="addOrder-list_bd">
