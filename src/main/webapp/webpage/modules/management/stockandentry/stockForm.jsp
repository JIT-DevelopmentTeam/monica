	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/stockandentry/stock/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="stock" action="${ctx}/stockandentry/stock/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
