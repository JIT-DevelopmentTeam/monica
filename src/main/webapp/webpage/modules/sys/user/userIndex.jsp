...
<body>
	...
	<div class="row">
	    ...
	    <div id="toolbar">
            ...
            <shiro:hasPermission name="sys:user:bindingERP">
                <button id="bindingERP" class="btn btn-primary" disabled onclick="bindingERP()">
                    <i class="glyphicon glyphicon-plus"></i> 绑定ERP
                </button>
            </shiro:hasPermission>
	    </div><!-- 工具栏结束 -->
