...
<head>
    ...
    <%@include file="itemFileList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <%--<div class="panel-heading">
            <h3 class="panel-title">上传商品图片列表</h3>
        </div>--%>
        <div class="panel-body">
            ...
            <div id="search-collapse" class="collapse">
                <div class="accordion-inner">
                    <form:form id="searchForm" modelAttribute="itemFile" class="form form-horizontal well clearfix">
                        <form:hidden path="itemId" htmlEscape="false" maxlength="100" class=" form-control" />
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <label class="label-item single-overflow pull-left" title="上传编码名称：">上传编码名称：</label>
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="management:itemfile:itemFile:del">
                ...
                <shiro:hasPermission name="management:itemfile:itemFile:view">
            ...
            <!-- 表格 -->
            <table id="itemFileTable" data-toolbar="#toolbar"></table>
